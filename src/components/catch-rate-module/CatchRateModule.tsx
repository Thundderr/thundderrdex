...
export function CatchRateModule({ module, isOverlay = false }: Props) {
  ...
  return (
    <div
      ...
      className={`col-span-1 md:col-span-2 rounded-lg ${moduleSizeClasses(module)} ${module.customHeight ? "" : "max-h-[calc(100vh-9.5rem)]"} flex flex-col bg-slate-900 border shadow-lg overflow-hidden ${
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 py-2 bg-slate-800 border-b border-slate-700 shrink-0">
        ...
        <div className="flex-1 mx-2 text-sm font-medium text-white truncate">Catch Rate</div>
