...
import { ScoutingModule } from "@/components/scouting/ScoutingModule";
...
function renderModule(module: AnyModule, isOverlay = false) {
  switch (module.moduleType) {
    ...
    case "scouting":
      return <ScoutingModule module={module} isOverlay={isOverlay} />;
    default:
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div ref={gridRef} data-module-grid className="grid gap-4 grid-flow-row-dense content-stretch md:grow md:shrink-0 grid-cols-1 md:[grid-template-columns:repeat(auto-fill,minmax(330px,1fr))]">
            {modules.map((module) => {
